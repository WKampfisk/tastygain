/**
 * Reads Base44 editor / hosting params from the URL and localStorage.
 * Required for iframe preview in app.base44.com (app_id, access_token, etc.).
 */
...
const DEFAULT_APP_ID = '6a8c70e20596effd80c14869';
...
const getAppParams = () => {
  ...
  return {
    appId: getAppParamValue('app_id', {
      defaultValue: import.meta.env.VITE_BASE44_APP_ID || DEFAULT_APP_ID,
    }),
